...
function Attaquant_centra() {
  ...
  <!-- <img src="./assets/img/Container.png" alt=""> -->
        <div  class=" btnCB relative top-[150px] w-[150px] h-[240px] bg-cover bg-center p-4 z-[2] transition ease-in duration-200" style="background-image: url('https://selimdoyranli.com/cdn/fut-player-card/img/card_bg.png');">
 <!-- Haut de la carte -->
 ...
 <div class="relative">
   ...
   <h1 class="absolute w-[60px] h-[30px] bottom-[-20px] bg-[#1e1d1d] left-1/2 transform -translate-x-1/2 text-center text-white rounded-full">add</h1>
 </div>
