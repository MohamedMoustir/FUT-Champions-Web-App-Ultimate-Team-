...
for (let i = 0; i < 2; i++) {
    ...
    document.getElementById("ST").innerHTML +=`
     ...
     <!-- <img src="./assets/img/Container.png" alt=""> -->
           <div  class=" btnST relative top-[150px] w-[150px] h-[240px] bg-cover bg-center p-4 z-[2] transition ease-in duration-200" style="background-image: url('https://selimdoyranli.com/cdn/fut-player-card/img/card_bg.png');">
    <!-- Haut de la carte -->
...
for (let i = 0; i < 1; i++) {
    ...
    document.getElementById("CM").innerHTML +=`
     ...
     <!-- <img src="./assets/img/Container.png" alt=""> -->
           <div class="btnCM relative top-[150px] w-[150px] h-[240px] bg-cover bg-center p-4 z-[2] transition ease-in duration-200" style="background-image: url('https://selimdoyranli.com/cdn/fut-player-card/img/card_bg.png');">
    <!-- Haut de la carte -->
    <div class="relative flex px-3 text-[#e9cc74]">
      <div class="absolute leading-[1.5rem] font-light uppercase py-2">
        <div class="text-base player-rating"><span>97</span></div>
